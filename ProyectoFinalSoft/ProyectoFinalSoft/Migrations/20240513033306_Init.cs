    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Horario_dia = table.Column<string>(type: "varchar(15)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Horario_hora_inicio = table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    Horario_hora_fin = table.Column<TimeSpan>(type: "time(6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ambientes_Ambiente_Codigo",
                table: "Ambientes",
                column: "Ambiente_Codigo",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Docentes_Docente_NumId",
                table: "Docentes",
                column: "Docente_NumId",
                unique: true);
